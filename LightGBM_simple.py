...
# Read csv file
calendar = pd.read_csv("./data_sets/calendar.csv", 
...
# Read csv file
prices = pd.read_csv("./data_sets//sell_prices.csv", 
                     dtype = priceDTypes)
...
# Read csv file
ds = pd.read_csv("./data_sets/test/sales_train_validation.csv", 
...
def create_ds():
    ...
    ds = pd.read_csv("./data_set/test/sales_train_validation.csv", 
                     usecols = catCols + numCols, dtype = dtype)
